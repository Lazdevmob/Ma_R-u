...
public class MeetingViewHolder extends RecyclerView.ViewHolder {
    ...
    public MeetingViewHolder(@NonNull MeetingItem2Binding binding) {
    ...
    public void displayMeetings(Meeting meeting) {
        //meetingDescription.setText(new StringBuilder().append(meeting.getSubject()).append(" ").append(meeting.getBeginDate()).toString());
        meetingDescription.setText(new StringBuilder().append(meeting.getSubject()).append(" - ").append(meeting.getBeginDate()).append(" - salle ").append(meeting.getRoomName()).toString());
